...
1. Make an [Issue](https://github.com/ligofff/lgf-universal-feedbacks/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-universal-feedbacks": "https://github.com/YOUR_USER/lgf-universal-feedbacks.git"
        }
    }
```
